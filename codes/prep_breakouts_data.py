...
# 爆点
def get_breakouts_text_asfiles(read_path, path_prefix, min_reviews=100, group_gap=15):
...
if __name__ == '__main__':
    ...
    get_breakouts_text_asfiles(read_path, path_prefix, min_reviews, group_gap)
